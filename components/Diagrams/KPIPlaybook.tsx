...
const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    diagnosis: 'Leads come in but VAs report they\'re unqualified — targeting too broad or pixel unseasoned',
    icon: '⚠️',
    severity: 'medium',
    prescriptions: [
      'Allow pixel seasoning (needs 50+ quality events)',
      'Add "advanced conditioning" — stricter survey questions',
      'Narrow geographic targeting',
      'Add demographic restrictions (homeowners, age, income)',
      'Review and tighten survey qualification logic',
    ],
    coordinate: [
      { who: 'Emmanuel', what: 'Pixel strategy and targeting refinement' },
    ],
  },
  {
    id: 'low-booking',
    symptom: 'Low Booking Rate',
    diagnosis: 'Leads come in but don\'t convert to appointments — VA or script issue',
    icon: '📞',
    severity: 'high',
    prescriptions: [
      'Audit VA response time (must be < 5 min)',
      'Review and refresh VA call scripts',
      'Check CRM automations for lead routing errors',
      'Improve lead nurture sequence (SMS, email)',
      'Retrain VAs on objection handling',
    ],
    coordinate: [
      { who: 'Layla / Aika', what: 'VA retraining and script review' },
      { who: 'Emmanuel', what: 'CRM automation audit' },
    ],
  },
  {
    id: 'low-show',
