...
const ROWS: Row[] = [
  ...
  },
  {
    ...
    perPod: {
      P1: { firstTry: 'Raymond (Pods 1 & 3)', ifStuck: 'Emmanuel' },
      P2: { firstTry: 'Bren (Pod 2)',           ifStuck: 'Emmanuel' },
      P3: { firstTry: 'Raymond (Pods 1 & 3)',   ifStuck: 'Emmanuel' },
      P4: { firstTry: 'Emmanuel / Mervin (no dedicated MB yet)', ifStuck: 'Jonathan' },
      P5: { firstTry: 'Emmanuel / Mervin (no dedicated MB yet)', ifStuck: 'Jonathan' },
    },
