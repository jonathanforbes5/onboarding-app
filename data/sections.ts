...
export const SECTIONS: SectionMeta[] = [
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        question: 'Layer 2 shows Link CTR of 0.4% and Link CPC of $9. What does this most likely indicate?',
        options: [
          'The campaign is performing well — these are normal numbers',
          'Creative fatigue — Link CTR below 0.8% and Link CPC above $6 signals the creative is no longer resonating with the audience',
          'A targeting issue — increase audience size',
          'A pixel problem — CAPI is not configured',
        ],
        correctIndex: 1,
        explanation: 'Link CTR benchmark: > 0.8%. Link CPC benchmark: < $6. Link CTR of 0.4% and Link CPC of $9 = creative is not resonating — likely fatigue. Prescription: check frequency (> 2.5 = fatigue incoming), then follow the Post-Andromeda duplicate protocol before ordering a full creative refresh.',
      },
      {
      ...
      },
      {
        ...
        options: ['> 5%', '> 10%', '> 15% — flag immediately as targeting or creative issue', '> 50%'],
        correctIndex: 2,
        explanation: 'OSA (Out of Service Area) benchmark: keep < 15%. Above 15% = flag immediately — likely a targeting issue (audience too broad, wrong geo) or creative is attracting the wrong market. Check targeting, exclude problem zip codes, review the Account Specific Document. Speed-to-Lead lives as a Layer 3 lever under OSA.',
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          '"Creative fatigue confirmed — frequency > 3.5, Link CTR below 0.8%. Plan: Post-Andromeda duplicate this week. If no recovery in 48h, full creative refresh: 15 new ads, zero reused photos, briefing Ken today."',
          '"I\'ll pause the campaign and restart with a fresh pixel"',
          '"This is normal — CTR fluctuates and frequency is fine at 4.2"',
        ],
        correctIndex: 1,
        explanation: 'Frequency 4.2 = well above the 3.5 action threshold. Link CTR 0.5% = below the 0.8% benchmark. Combined diagnosis: creative fatigue confirmed. Report: (1) Running Post-Andromeda duplicate protocol now. (2) If no Link CTR recovery in 48 hours, full creative refresh: 15 all-new ads (no reused photos) briefed to Ken today. Be specific and timeline-driven in review calls — "I\'ll look into it" is not an answer.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    slug: 'weekly-rhythm',
    title: 'Weekly Rhythm',
    subtitle: 'Mon–Sat cadence + your daily morning routine',
    estimatedTime: '8 min',
    icon: 'Clock',
    quiz: [
      {
        question: 'You walk in Monday morning. What is the first 30 minutes?',
        options: [
          'Open ClickUp and start executing tasks',
          'Communication triage (Slack + email) → Command Centre scan → ClickUp triage. Same routine every day.',
          'Wait for the standup meeting',
          'Check your inbox only',
        ],
        correctIndex: 1,
        explanation: 'Communication triage and Command Centre check happen in the first 30 minutes of EVERY working day. No exceptions. You will be tempted to skip them when you are "too busy" — that is exactly when skipping costs you most.',
      },
      {
        question: 'Tuesday is pod meeting day. What should you walk into the meeting with?',
        options: [
          'Open questions',
          'Data + reports prepped Monday + a list of action items you ALREADY took on red accounts since last meeting',
          'Just yourself — Jon will lead',
          'A list of complaints about specialists',
        ],
        correctIndex: 1,
        explanation: 'Tuesday meeting is high-throughput. Bring data, leave with action items. Monday is the prep day specifically for this — reactive Monday means unprepared Tuesday means a worse week.',
      },
      {
        question: 'Friday afternoon pod meeting just ended. You have action items. What is the rule?',
        options: [
          'Roll them into Monday',
          'Take action SAME DAY before close-of-business. Send proactive client updates going into the weekend.',
          'Email them to yourself for the weekend',
          'Wait for the assigned ClickUp task',
        ],
        correctIndex: 1,
        explanation: 'Weekend silence after a Friday meeting trains clients to assume nothing happens. Friday-afternoon updates keep the relationship warm. Many clients work Saturdays — be visible without being intrusive.',
      },
      {
        question: 'A client wants a call on Wednesday afternoon. You had blocked that time for action items from Tuesday\'s meeting. What is the right call?',
        options: [
          'Always say yes — clients come first',
          'Always decline — protect your blocks',
          'Triage: take the call IF the issue is genuinely urgent, but do not let ad-hoc client asks displace your meeting action items entirely. Move smaller tasks to compensate.',
          'Ask Jon to take the call',
        ],
        correctIndex: 2,
        explanation: 'Things will come up. Triage urgency. The pod-meeting action items are usually downstream of the most important client outcomes — protect them. If you keep displacing them, you signal to Jon that your week is reactive, not strategic.',
      },
    ],
  },
  {
    id: 18,
    slug: 'other-departments',
    title: 'Other Departments',
    subtitle: 'Tour of the agency outside your pod',
    estimatedTime: '10 min',
    icon: 'Network',
    quiz: [
      {
        question: 'A client is complaining that their VAs are slow to respond. Who do you contact?',
        options: [
          'The individual VA assigned to the client',
          'Leila — Head of VA. NEVER ping individual VAs. All quality / speed / qualification issues route through her.',
          'Aica or Pamela',
          'Jonathan',
        ],
        correctIndex: 1,
        explanation: 'Leila is the head of the VA team and controls the escalation path. Pinging individual VAs creates accountability gaps. Use #manager-discussion for VA coordination.',
      },
      {
        question: 'You need a creative refresh. Your media buyer is busy. What is the right path?',
        options: [
          'Task Ken immediately',
          'Source organic content first (client → public assets → website / social) → only after exhausting that, task Ken to fill gaps with AI-generated assets',
          'Wait for the media buyer to surface it',
          'Ask Jon to escalate',
        ],
        correctIndex: 1,
        explanation: 'Ken is a substitute, not a default. Always try organic content first. Be specific and persistent in what you ask the client. Use Ken to fill the gaps with AI-generated assets — combined with organic.',
      },
      {
        question: 'A client says "I was promised 30 booked appointments per cycle" but the contract says 20. Who is your FIRST call?',
        options: [
          'Mani',
          'Oscar',
          'The original closer who closed the deal — to find out what was actually said on the call. Only AFTER that context goes to Mani.',
          'The client themselves',
        ],
        correctIndex: 2,
        explanation: 'Always talk to the closer first. Mani is the call of last resort on closer accountability — not the first call. He needs the closer-side context to actually do anything useful.',
      },
      {
        question: 'You want to delegate a GHL setup. What is the standard task format?',
        options: [
          'Slack DM Emmanuel with the basics',
          'ClickUp task with: client name, GHL sub-account link, 48hr deadline. Emmanuel is lead; Mervin handles overflow.',
          'Verbal handoff at the next meeting',
          'Email Mani',
        ],
        correctIndex: 1,
        explanation: 'No ClickUp task = no work gets done. Always include client name, GHL sub-account link, and a specific deadline. Slack DMs disappear; ClickUp tasks are tracked.',
      },
    ],
  },
  {
    ...
    subtitle: 'KRS, Gutter Shutter, Stonegrove — preferred-partner relationships',
    estimatedTime: '6 min',
    icon: 'Target',
    quiz: [
      {
        question: 'A new client mentions they are a Klaus Roofing Systems dealer. What is different about this account?',
        options: [
          'Nothing — same pricing as other clients',
          'They get preferred pricing ($3,300/cycle vs the $4,000 standard) — confirm with Jon or Oscar before quoting',
          'They get the same pricing but different creatives',
          'They cannot use our standard onboarding flow',
        ],
        correctIndex: 1,
        explanation: 'KRS is a preferred-partner network earned through past performance for early dealers. Always check on the onboarding call: "are you a KRS dealer?" If yes, pause before quoting and confirm pricing.',
      },
      {
        question: 'On the onboarding call with what looks like a roofing client, what should you ALWAYS ask?',
        options: [
          'How much they spend on marketing',
          '"Are you part of any dealer network — KRS, Gutter Shutter, Stonegrove?"',
          'Whether they have a CRM',
          'Their close rate',
        ],
        correctIndex: 1,
        explanation: 'Quoting standard pricing to a partner client is an awkward correction. Quoting partner pricing to a non-partner client is a permanent revenue leak. Ask the question every time.',
      },
      {
        question: 'How did the Stonegrove relationship start?',
        options: [
          'Cold outbound from the Stonegrove leadership',
          'A referral from Bill Wright / Tanner at Integrity Roofing in Seattle, after we delivered great results for them — they referred us into the broader Stonegrove dealer network',
          'A paid partnership deal',
          'A trade show meeting',
        ],
        correctIndex: 1,
        explanation: 'Stonegrove is a private equity firm with a portfolio of roofing companies. Integrity Roofing (Bill / Tanner) referred us in after we delivered. The preferred pricing exists because the relationship was earned.',
      },
      {
        question: 'A Stonegrove dealer has a sudden ownership change mid-cycle. What is the heightened risk?',
        options: [
          'No different from a non-partner client',
          'PE-backed shops have decision-maker churn more often — "change in ownership" is a documented churn pattern in our Airtable. Watch for it and flag early.',
          'They will automatically renew',
          'Nothing — Stonegrove guarantees retention',
        ],
        correctIndex: 1,
        explanation: 'We have lost 2 accounts to "change in ownership/decision-makers." PE-backed dealers carry more of this risk. Flag it the moment you see signals — new contact email, slower decisions, contract questions.',
      },
    ],
  },
  {
